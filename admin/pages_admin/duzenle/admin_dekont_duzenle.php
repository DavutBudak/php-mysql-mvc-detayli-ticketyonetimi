<?php
    $id = intval($_GET["id"]);
    $uyefoto = $db->prepare("SELECT * FROM uye_dekont_dosyalari WHERE id = ?");
...
<div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>Dekont Düzenle</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Anasayfa</a></li> 
        <li><a href="#"><i class="fa fa-home"></i> Menü</a></li> 
        <li><a href="#"><i class="fa fa-home"></i>Dekont Düzenle</a></li> 
        <li><a href="#"><i class="fa fa-home"></i> Dekont Düzenleme Sayfası</a></li> 
      </ol>
    </section>
      ...
      <div class="col-lg-12">
          <div class="chart-box">
            <div class="head-title">
              <h4 style="text-align: center;">Dekont Dosyasını Güncelle </h4>
        ...
        if ($resimBoyutu > (1024 * 1024 * 2)) {
            ...
            if ($tip == 'image/jpeg' || $tip == 'image/jpg' || $tip == 'image/png') { //uzantısnın kontrolünü sağladık. sadece .jpg ve .png yükleyebilmesi için.
                if (move_uploaded_file($_FILES["uye_dekont"]["tmp_name"][$i], $klasor . "/" .$randomubunaal=$rand. $_FILES['uye_dekont']['name'][$i])) {
                    ...
                    $resimekle = $db->prepare("UPDATE uye_dekont_dosyalari SET uye_dekont = ? , resim_tarih = ? WHERE id = ?");
                    $resimekle->execute(array($uye_dekont,$resim_tarih, $id));
